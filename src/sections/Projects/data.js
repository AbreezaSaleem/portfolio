export default [
  ...
  },
  {
    ...
    details:
      `Created a chat module in ReactJS containing features like last seen, media files support, archive/unarchive conversation.
  ...
  },
  {
    ...
    description: "A plagiarism detection tool that generated Program Dependance Graphs of two source codes and compared them both using subgraph isomorphism to detect disguised code changes",
    details:
